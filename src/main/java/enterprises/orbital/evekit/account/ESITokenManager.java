...
public class ESITokenManager {
  public static final String PROP_TOTAL_TOKEN_LIMIT = "enterprises.orbital.evekit.tokenLimit";
  ...
  public static String createToken(HttpServletRequest req, EveKitUserAccount userAccount, String scopes,
